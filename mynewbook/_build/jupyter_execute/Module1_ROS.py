...
get_ipython().system('rosnode --help')
...
get_ipython().system('rosnode info /teleop_twist_keyboard')
...
get_ipython().system('rostopic --help')
...
get_ipython().system('rostopic info /cmd_vel')
...
get_ipython().system('rostopic echo /cmd_vel')
...
get_ipython().system('rostopic type /cmd_vel')


# In[12]:


get_ipython().system('rosmsg show geometry_msgs/Twist')
...
get_ipython().system('rostopic type /cmd_vel | rosmsg show')
